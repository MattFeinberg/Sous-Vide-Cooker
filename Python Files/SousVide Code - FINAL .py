...
ssid = 'mattyfein'       #hide this in submission
password = 'lynnetapper' #hide this in submission
...
publish_directory = 'Second_steak_temp' #Change this
